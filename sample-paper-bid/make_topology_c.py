...
House style matches make_figs.py. Output: topology_c.pdf (+ .png preview).
"""
import os
import matplotlib
matplotlib.use("Agg")
...
fig.savefig(os.path.join(OUT, "topology_c.pdf"))
fig.savefig(os.path.join(OUT, "topology_c.png"), dpi=300)
print("wrote", os.path.join(OUT, "topology_c.pdf"))
